...
do
    ...
    gcloud compute scp --ssh-key-file ~/.ssh/cloud-computing ubuntu@client-measure-$CLIENT_MEASURE_ID:~/memcache-perf/exp-$EXP.txt ./experiments/exp-$EXP.txt --zone europe-west3-a
